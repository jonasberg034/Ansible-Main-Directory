...
- src: git+https://github.com/UnderGreen/ansible-prometheus-node-exporter
  version: master
```
* Bunun icin dokumentasyona bak! Google >> installing roles
...
- ansible-playbook playbook.yml   Hata alacaksin. Bu hatayi asagida duzeltiyorsun.
...
- ansible-playbook playbook.yml komutunu uygula. Hatanin duzeltildigini gor.
